...
?>
<h2 class="sec-title"><?php _e( 'Order Details', 'woocommerce' ); ?></h2>
...
<?php do_action( 'woocommerce_order_details_after_order_table', $order ); ?>
   <div class="box transparent-box with-title">   
<header>
    <h2 class="box-title"><?php _e( 'Customer details', 'woocommerce' ); ?></h2>
</header>
           <div class="box-entry">
<dl class="customer_details add-bottom">
<?php
